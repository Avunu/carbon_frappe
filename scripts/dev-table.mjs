 ...
 * bench — the JS twin of scripts/dev-compile.mjs.
 *
 ...
 *
 *   node scripts/dev-table.mjs           # build .dev-dist/table-demo.{js,css,html}
 *   node scripts/dev-table.mjs --serve   # ...and serve it on :8123
 */
...
const esbuild = require(path.join(frappeRoot, "node_modules", "esbuild"));
...
await esbuild.build({
	entryPoints: [path.join(appRoot, "dev", "table-demo.js")],
